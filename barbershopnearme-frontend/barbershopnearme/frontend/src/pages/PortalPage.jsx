...
const T = {
  ...
  ink4: '#1e1612',
  bone: '#E8DFC8',
  bone2: 'rgba(232,223,200,.55)',
  bone3: 'rgba(232,223,200,.12)',
  blood: '#8B1A1A',
  blood2: '#6B0F0F',
  bloodDim: 'rgba(139,26,26,.18)',
  bloodBorder: 'rgba(139,26,26,.45)',
  green: '#4ade80',
  greenDim: 'rgba(74,222,128,.1)',
  greenBorder: 'rgba(74,222,128,.25)',
  red: '#f87171',
  redDim: 'rgba(248,113,113,.06)',
  redBorder: 'rgba(248,113,113,.25)',
  gold: '#C8A840',
  goldDim: 'rgba(200,168,64,.12)',
  goldBorder: 'rgba(200,168,64,.3)',
  dim: 'rgba(232,223,200,.38)',
  deep: 'rgba(232,223,200,.14)',
}
...
function BookingCalendar({ selectedDate, onSelect, workingDays = [], timeOffDates = [] }) {
  ...
  workingDays.forEach((d) => {
    dowMap[(d.day_of_week + 1) % 7] = d.is_working
  })
  ...
  const openDayNames = workingDays
    ...
    <RHBox i={2} style={{ overflow: 'visible' }}>
      ...
      <div
        style={{
          background: T.ink,
          padding: '14px 18px',
          borderRadius: `${RH[2].split('/')[0].split(' ')[0]} ${RH[2].split('/')[0].split(' ')[1]} 0 0`,
          borderBottom: `1px solid ${T.bone3}`,
          display: 'flex',
      ...
      >
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.borderColor = T.blood
            e.currentTarget.style.color = T.blood
            e.currentTarget.style.background = T.bloodDim
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = T.bone3
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ ...mono, fontSize: 9, color: T.dim, letterSpacing: '.3em', marginTop: 2 }}>
            {viewYear}
          </p>
        </div>
        <button
      ...
      <div style={{ padding: '14px 14px 16px' }}>
        {/* day labels */}
        <div
          style={{ display: 'grid', gridTemplateColumns: 'repeat(7,1fr)', marginBottom: 8, gap: 2 }}
        >
          {DAYS.map((d) => (
            <div
              key={d}
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!disabled && !selected) {
                    e.currentTarget.style.background = T.bloodDim
                    e.currentTarget.style.borderColor = T.bloodBorder
                    e.currentTarget.style.color = T.blood
                  }
                }}
                onMouseLeave={(e) => {
                  if (!disabled && !selected) {
                    e.currentTarget.style.background = isToday ? T.bloodDim : 'transparent'
                    e.currentTarget.style.borderColor = isToday ? T.bloodBorder : 'transparent'
                    e.currentTarget.style.color = isToday ? T.blood : T.bone2
                  }
                }}
              >
                {showSlash && (
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            <div
              style={{
                width: 10,
                height: 10,
                background: T.bloodDim,
                border: `1px solid ${T.bloodBorder}`,
                borderRadius: '3px',
              }}
            />
          ...
          {openDayNames && (
            <span style={{ ...mono, fontSize: 8, color: T.green }}>Open: {openDayNames}</span>
          )}
        </div>
      </div>
    </RHBox>
...
function TimeSlotGrid({
        ...
        <div style={{ position: 'relative', width: 48, height: 48 }}>
          <div
            style={{
              position: 'absolute',
              inset: 0,
              border: `2px solid ${T.bloodBorder}`,
              borderTopColor: T.blood,
              borderRadius: '50%',
          ...
          <div
            style={{
              ...
              inset: 6,
              border: `1px solid ${T.bloodBorder}`,
              borderBottomColor: T.blood,
              borderRadius: '50%',
              animation: 'rhSpin .6s linear infinite reverse',
            }}
          />
        </div>
        <p
  ...
  if (timeOff)
    return (
      ...
      >
        ...
        <p style={{ ...mono, fontSize: 12, color: T.dim, lineHeight: 1.7 }}>
          {message || 'Barber is off this day. Try another date.'}
        </p>
      </RHBox>
    )
  ...
  return (
    <div
      style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(90px,1fr))', gap: 8 }}
    >
      {slots.map((slot, si) => {
        ...
        return (
          <button
            ...
            onMouseEnter={(e) => {
              if (!isBooked && !isSelected) {
                ...
                e.currentTarget.style.borderColor = T.blood
                e.currentTarget.style.transform = 'scale(1.06) rotate(-.5deg)'
                e.currentTarget.style.boxShadow = `3px 3px 0 ${T.blood2}`
              }
            }}
            onMouseLeave={(e) => {
              if (!isBooked && !isSelected) {
          ...
          >
            ...
            {isSelected && (
              <span style={{ position: 'absolute', top: 3, right: 6, fontSize: 10, color: T.bone }}>
                ✓
              </span>
            )}
    ...
    >
      ...
      {[...Array(12)].map((_, i) => (
        <div
          ...
          style={{
            ...
            animation: `confettiDrop ${1.4 + i * 0.18}s ease-in ${i * 0.12}s both`,
            pointerEvents: 'none',
            zIndex: 0,
          }}
        />
      ...
      <div
        style={{
          position: 'fixed',
          inset: 0,
          background: `radial-gradient(ellipse at 50% 40%,rgba(139,26,26,.15) 0%,transparent 70%)`,
          pointerEvents: 'none',
        }}
      />
      <div
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 540 }}>
        ...
        <div
          style={{
            textAlign: 'center',
            marginBottom: 24,
            animation: 'rhFloat 3s ease-in-out infinite',
          }}
        >
        ...
        <div
          style={{
            textAlign: 'center',
            marginBottom: 32,
            animation: 'rhPop .6s cubic-bezier(.34,1.56,.64,1) both',
          }}
        >
          <p
            style={{
        ...
        <div style={{ animation: 'rhSlide .5s .25s cubic-bezier(.16,1,.3,1) both' }}>
          <RHBox i={1} glow style={{ marginBottom: 24 }}>
            ...
            <div
              style={{
                background: `repeating-linear-gradient(90deg,${T.blood} 0,${T.blood} 6px,transparent 6px,transparent 12px)`,
                height: 3,
                marginBottom: 0,
                opacity: 0.6,
                borderRadius: `${RH[1].split('/')[0].split(' ')[0]} ${RH[1].split('/')[0].split(' ')[1]} 0 0`,
              }}
            />
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              <div
                style={{
                  ...
                  marginBottom: 20,
                  paddingBottom: 18,
                  borderBottom: `1px dashed ${T.bone3}`,
                }}
              >
                <p
                  style={{
              ...
              >
                {[
                  ...
                  [
                    '💇 Duration',
                    data.service?.duration_minutes ? `${data.service.duration_minutes} min` : '—',
                  ],
                  ...
                  >
                    ...
                    <p style={{ ...sf, fontSize: 14, color: T.bone, margin: 0, lineHeight: 1.1 }}>
                      {val}
                    </p>
                  </div>
                ))}
              ...
              <div style={{ textAlign: 'center' }}>
                <span
                  style={{
                    ...
                    borderRadius: PILL,
                    color: data.payment === 'shop' ? T.gold : T.green,
                    padding: '8px 20px',
                    display: 'inline-block',
                  }}
                >
            ...
            <div
              style={{
                ...
                height: 3,
                opacity: 0.6,
                borderRadius: `0 0 ${RH[1].split('/')[1].trim().split(' ').slice(2).join(' ')}`,
              }}
            />
          </RHBox>
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            <p style={{ ...mono, fontSize: 10, color: T.dim }}>
              📍 123 Noir Alley, Hattiesburg, MS — See you there!
            </p>
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <Link
              ...
              style={{
                ...
                boxShadow: `4px 4px 0 ${T.bone3}`,
                display: 'block',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.04) rotate(-.5deg)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'none'
              }}
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = T.bone3
                e.currentTarget.style.color = T.bone2
                e.currentTarget.style.transform = 'none'
              }}
            >
              Book Another ✂
...
export default function PortalPage() {
  ...
  useEffect(() => {
    ...
    api
      .get(`barbers/${preBarber.id}/working-days/`)
      .then((d) => {
    ...
    api
      .get(`services/?barber=${preBarber.id}`)
    ...
    Promise.allSettled([api.get('services/'), api.get('barbers/')])
      .then(([svcR, barbR]) => {
        ...
        if (barbR.status === 'fulfilled') {
          ...
          list.forEach((barber) => {
            api
              .get(`barbers/${barber.id}/working-days/`)
              .then((d) => setBarberSchedules((prev) => ({ ...prev, [barber.id]: d })))
              .catch(() => {})
          })
        } else {
          setDataError('Could not load barbers. Make sure Django is running.')
        }
      })
  ...
  const fetchSlots = useCallback(async () => {
    ...
    try {
      ...
      if (d.time_off) {
        setTimeOff(true)
        setTimeOffMessage(d.message || 'Barber not available this day.')
      } else {
  ...
  const handleBook = async () => {
    ...
    try {
      ...
      setError(
        d?.detail || d?.non_field_errors?.[0] || 'Booking failed — that slot may already be taken.'
      )
    } finally {
      setSubmitting(false)
    }
  ...
  if (confirmed && confirmData)
    return <ConfirmedScreen data={confirmData} onBookAnother={resetPortal} />
  if (!user) return null
    ...
    <div style={{ minHeight: '100vh', background: T.ink, color: T.bone, position: 'relative' }}>
      ...
      <div
        style={{
          ...
          zIndex: 0,
          pointerEvents: 'none',
          backgroundImage: `linear-gradient(rgba(232,223,200,.012) 1px,transparent 1px),linear-gradient(90deg,rgba(232,223,200,.012) 1px,transparent 1px)`,
      ...
      <div
        style={{
          ...
          width: 600,
          height: 600,
          background: `radial-gradient(circle,rgba(139,26,26,.08) 0%,transparent 65%)`,
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
      ...
      >
                ...
                {i < 3 && (
                  <div
                    ...
                    style={{
                      flex: 1,
                      height: 2,
                      background: step > i + 1 ? T.blood : T.deep,
        ...
        <div style={{ marginBottom: 32, animation: 'rhFadeUp .5s cubic-bezier(.16,1,.3,1) both' }}>
          ...
          >
            ...
            <span style={{ color: T.blood }}>
              {['Service_', 'Barber_', 'Schedule_', 'In_'][step - 1]}
            </span>
          </h1>
        </div>
            ...
            {[1, 2, 3].map((i) => (
              <div
                ...
                style={{
                  height: 80,
                  borderRadius: RH[i % 4],
                  background: `linear-gradient(90deg,rgba(232,223,200,.02) 25%,rgba(232,223,200,.05) 50%,rgba(232,223,200,.02) 75%)`,
          ...
          <>
            ...
            {step === 1 && (
              ...
              >
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      {(selectedBarber.photo_url || selectedBarber.photo_data) && (
                        ...
                        >
                          <img
                            src={selectedBarber.photo_url || selectedBarber.photo_data}
                ...
                {services.length === 0 ? (
                  <p style={{ ...sf, fontSize: 18, color: T.deep, textTransform: 'uppercase' }}>
                  ...
                  services.map((svc, i) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        selectedBarber ? setStep(3) : setStep(2)
                      }}
                      style={{
                        display: 'flex',
                        justifyContent: 'space-between',
                        ...
                        transition: 'all .25s cubic-bezier(.34,1.56,.64,1)',
                        textAlign: 'left',
                        boxShadow: `3px 3px 0 rgba(139,26,26,.15)`,
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.borderColor = T.blood
                        e.currentTarget.style.background = T.bloodDim
                        e.currentTarget.style.transform = 'translateX(4px) rotate(.2deg)'
                        e.currentTarget.style.boxShadow = `5px 5px 0 ${T.blood2}`
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.borderColor = T.bone3
                        e.currentTarget.style.background = T.ink2
                        e.currentTarget.style.transform = 'none'
                        e.currentTarget.style.boxShadow = `3px 3px 0 rgba(139,26,26,.15)`
                      }}
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                        ...
                        >
                          <span style={{ ...sf, fontSize: 16, color: T.blood }}>
                        ...
                        <div>
                          ...
                          {svc.duration_minutes && (
                            <p style={{ ...mono, fontSize: 10, color: T.dim, margin: 0 }}>
                              {svc.duration_minutes} min ✦ in the chair
                            </p>
                          )}
                        </div>
                      </div>
                      <div style={{ textAlign: 'right', flexShrink: 0 }}>
                        <p
                          style={{ ...sf, fontSize: 28, color: T.blood, margin: 0, lineHeight: 1 }}
                        >
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: 72,
                          flexShrink: 0,
                          border: `3px solid ${T.bloodBorder}`,
                          overflow: 'hidden',
                          background: '#111',
                          position: 'relative',
                          borderRadius: RH[bi % 4],
                        ...
                        {b.photo_url || b.photo_data ? (
                          ...
                          <div
                            style={{
                              ...
                              alignItems: 'center',
                              justifyContent: 'center',
                              background: `linear-gradient(135deg,${T.ink3},${T.ink2})`,
                            }}
                          >
                            <span style={{ ...sf, fontSize: 26, color: T.blood }}>
              ...
              <div style={{ animation: 'rhFadeUp .4s cubic-bezier(.16,1,.3,1) both' }}>
                ...
                >
                  <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
                    <span
                      style={{ ...rub, fontSize: 14, textTransform: 'uppercase', color: T.blood }}
                    >
                      ✂ {selectedService?.name}
                    </span>
                  ...
                  <div style={{ marginBottom: 28 }}>
                    ...
                    >
                      ...
                      {!loadingSlots && !timeOff && availableSlots.length > 0 && (
                        <span style={{ ...mono, fontSize: 9, color: T.green }}>
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    padding: '18px',
                    background: !selectedDate || !selectedTime ? T.ink3 : T.blood,
                    color: !selectedDate || !selectedTime ? T.deep : T.bone,
                    ...sf,
                    fontSize: 18,
                    fontWeight: 700,
                    letterSpacing: '.2em',
                    textTransform: 'uppercase',
                    border: `3px solid ${!selectedDate || !selectedTime ? T.deep : T.bone}`,
                    borderRadius: PILL,
                    cursor: !selectedDate || !selectedTime ? 'not-allowed' : 'pointer',
                    transition: 'all .25s cubic-bezier(.34,1.56,.64,1)',
                    boxShadow: selectedDate && selectedTime ? `5px 5px 0 ${T.bone3}` : '',
                  }}
                  onMouseEnter={(e) => {
              ...
              <div style={{ animation: 'rhFadeUp .4s cubic-bezier(.16,1,.3,1) both' }}>
                ...
                <RHBox i={1} glow style={{ marginBottom: 24, overflow: 'visible' }}>
                  ...
                  >
                    ...
                    <ScissorsIcon size={20} color={T.bone} opacity={0.7} />
                  </div>

                  {/* perforated strip */}
                  <div
                    style={{
                      background: `repeating-linear-gradient(90deg,${T.bone3} 0,${T.bone3} 6px,transparent 6px,transparent 12px)`,
                      height: 3,
                    }}
                  />
                      ...
                      {[
                        ...
                        >
                          ...
                          <p
                            style={{
                              ...sf,
                              fontSize: label.includes('Date') ? 12 : 16,
                              color: T.bone,
                              margin: 0,
                              lineHeight: 1.1,
                            }}
                ...
                <RHBox i={0} style={{ padding: '18px 20px', marginBottom: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    {[
                      ['shop', '💵', 'Pay In Shop', T.gold, T.goldDim, T.goldBorder],
                      ['online', '💳', 'Pay Online', T.green, T.greenDim, T.greenBorder],
                    ].map(([val, emoji, label, color, bg, border]) => (
                      <button
                        key={val}
                        ...
                        style={{
                          flex: 1,
                          padding: '16px 8px',
                          background: paymentMethod === val ? bg : T.ink,
                          border: `2px solid ${paymentMethod === val ? color : T.bone3}`,
                          borderRadius: RH[val === 'shop' ? 0 : 2],
                          color: paymentMethod === val ? color : T.dim,
                          ...sf,
                          fontSize: 15,
                          letterSpacing: '.08em',
                          textTransform: 'uppercase',
                          cursor: 'pointer',
                          transition: 'all .2s',
                          boxShadow: paymentMethod === val ? `3px 3px 0 ${border}` : '',
                        }}
                        onMouseEnter={(e) => {
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    padding: '20px',
                    background: submitting ? T.bloodDim : T.blood,
                    color: T.bone,
                    ...sf,
                    fontSize: 20,
                    fontWeight: 700,
                    ...
                    boxShadow: `5px 5px 0 ${T.bone3}`,
                  }}
                  onMouseEnter={(e) => {
                    if (!submitting) {
                      e.currentTarget.style.transform = 'scale(1.02) rotate(-.3deg)'
                      e.currentTarget.style.background = T.blood2
                      e.currentTarget.style.boxShadow = `7px 7px 0 ${T.bone3}`
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (!submitting) {
                      e.currentTarget.style.transform = 'none'
                      e.currentTarget.style.background = T.blood
                      e.currentTarget.style.boxShadow = `5px 5px 0 ${T.bone3}`
                    }
                  }}
                >
                  {submitting ? (
