            ...
            <div style={{marginBottom:16,padding:"12px 14px",background:"rgba(239,68,68,0.04)",border:"1px solid rgba(239,68,68,0.12)"}}>
              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                ...
                <button onClick={()=>onStrike&&onStrike(appt.id,"late_cancel")}
                  style={{padding:"7px 14px",background:"rgba(139,26,26,0.06)",border:"1px solid rgba(139,26,26,0.2)",color:"#8B1A1A",...sf,fontSize:6,letterSpacing:"0.1em",textTransform:"uppercase",cursor:"pointer",transition:"all 0.2s"}}
              ...
              <button key={i} onClick={()=>onSelect(iso)}
                ...
                {hasAppt && (
                  <div style={{
                    ...
                    <span style={{fontFamily:"'Courier Prime',monospace", fontSize:7, fontWeight:900, lineHeight:1}}>{count > 99 ? "99+" : count}</span>
                  </div>
                )}
      ...
      <div onClick={e=>e.stopPropagation()}
        ...
        <div style={{ padding:"4px 24px 24px", display:"flex", gap:10 }}>
          ...
          <button onClick={onConfirm}
            style={{ flex:1, padding:"13px 16px", background:`${acc}15`, border:`1px solid ${acc}55`, color:acc, fontFamily:"'Bebas Neue',sans-serif", fontSize:8, fontWeight:900, letterSpacing:"0.15em", textTransform:"uppercase", cursor:"pointer", transition:"all 0.18s", clipPath:"polygon(0 0,calc(100% - 6px) 0,100% 6px,100% 100%,6px 100%,0 calc(100% - 6px))" }}
      ...
      <div style={{position:"relative",zIndex:10,maxWidth:1280,margin:"0 auto",padding:isMobile?"116px 14px max(40px,env(safe-area-inset-bottom))":"120px 32px 64px"}}>
          ...
          <div className="bd-enter">
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · FEEDBACK</p>
          ...
          <div className="bd-enter">
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(167,139,250,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · REQUESTS</p>
                      ...
                      <div style={{padding:"18px 20px"}}>
                        ...
                        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr auto 1fr",gap:8,marginBottom:isPending?20:0,alignItems:"stretch"}}>
                          ...
                          <div style={{padding:"14px 16px",background:isPending?"rgba(139,26,26,0.04)":isAccepted?"rgba(34,197,94,0.04)":"rgba(255,255,255,0.02)",border:`1px solid ${isPending?T.amberBorder:isAccepted?"rgba(34,197,94,0.2)":T.border}`}}>
                            <p style={{...mono,fontSize:8,color:isPending?"rgba(139,26,26,0.5)":isAccepted?"rgba(34,197,94,0.5)":"#52525b",letterSpacing:"0.3em",textTransform:"uppercase",marginBottom:8}}>
          ...
          <div className="bd-enter">
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                <div style={{width:4,height:28,background:"linear-gradient(to bottom,#a78bfa,#f59e0b)",flexShrink:0}}/>
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(167,139,250,0.6)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · REQUESTS</p>
                  <p style={{...sf,fontSize:13,fontWeight:900,textTransform:"uppercase"}}>Reschedule Requests</p>
                </div>
              </div>
              <div style={{display:"flex",gap:8,alignItems:"center"}}>
        ...
        {activeTab==="walkin"&&(
          <div className="bd-enter" style={{maxWidth:600}}>
            ...
            <div style={{marginBottom:28}}>
              <p style={{...mono,fontSize:8,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:6}}>Barbershopnearme · FRONT DESK</p>
                ...
                <div>
                  <label style={{...sf,fontSize:6,letterSpacing:"0.4em",color:T.muted,textTransform:"uppercase",display:"block",marginBottom:8}}>
                    ...
                    {wiSlotsLoad
                      ...
                      : <span style={{...mono,fontSize:8,color:"rgba(139,26,26,0.35)",letterSpacing:"0.15em"}}>— same schedule clients see</span>
                    }
                  </label>
                  {wiSlotsLoad ? (
          ...
          <div className="bd-enter">
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · QUEUE</p>
          ...
          <div className="bd-enter">
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                <div style={{width:4,height:28,background:"linear-gradient(to bottom,#ef4444,#f59e0b)"}}/>
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · ROSTER</p>
              ...
              <div style={{background:T.surface,border:`1px solid ${T.amberBorder}`,padding:"20px",marginBottom:16,
                ...
                <div style={{display:"flex",gap:8}}>
                  <button onClick={async()=>{
                    ...
                    style={{padding:"11px 22px",background:"rgba(139,26,26,0.15)",border:`1px solid ${T.amberBorder}`,color:T.amber,...sf,fontSize:7,fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",cursor:blastBusy?"not-allowed":"pointer",
                      clipPath:"polygon(0 0,calc(100% - 7px) 0,100% 7px,100% 100%,7px 100%,0 calc(100% - 7px))"}}>
          ...
          <div className="bd-enter">
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                <div style={{width:4,height:28,background:"linear-gradient(to bottom,#ef4444,#f59e0b)"}}/>
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · ANALYTICS</p>
          ...
          <div className="bd-enter">
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24,flexWrap:"wrap",gap:12}}>
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  <p style={{...mono,fontSize:7,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:2}}>Barbershopnearme · UPDATES</p>
        ...
        {activeTab==="pricing"&&(
          <div className="bd-enter" style={{maxWidth:580}}>
            ...
            {/* Header */}
            <div style={{marginBottom:28}}>
              <p style={{...mono,fontSize:8,color:"rgba(139,26,26,0.5)",letterSpacing:"0.5em",textTransform:"uppercase",marginBottom:6}}>Barbershopnearme · YOUR RATES</p>
              <h2 style={{...sf,fontSize:22,fontWeight:900,textTransform:"uppercase",letterSpacing:"-0.03em",margin:0}}>
                  ...
                  <div style={{
                    ...
                    {uploadingPhoto ? (
                      <div style={{width:"100%",height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:8}}>
                        ...
                        <p style={{...mono,fontSize:8,color:"rgba(139,26,26,0.6)",letterSpacing:"0.3em"}}>SAVING</p>
                      </div>
