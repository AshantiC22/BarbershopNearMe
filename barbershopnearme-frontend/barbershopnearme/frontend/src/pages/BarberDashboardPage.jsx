...
const T = {
  ...
  amber: '#8B1A1A',
  amberDim: 'rgba(139,26,26,0.15)',
  amberBorder: 'rgba(139,26,26,0.4)',
  green: '#4ade80',
...
function ApptTicket({
  ...
  const saveNote = async () => {
    setSaving(true)
    try {
      await api.patch(`barber/appointments/${appt.id}/`, { barber_notes: note })
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
            <span style={{ ...mono, fontSize: 12, color: '#d4d4d4' }}>
              {appt.client_name || appt.client || appt.username || 'Client'}
            </span>
            {appt.barber_name && (
              <span style={{ ...mono, fontSize: 13, color: T.amber }}>✂️ {appt.barber_name}</span>
            )}
            {appt.client_notes && (
              <span style={{ ...mono, fontSize: 13, color: T.amber, fontStyle: 'italic' }}>
                "{appt.client_notes}"
              </span>
            )}
          </div>
          <div style={{ display: 'flex', gap: 10, marginTop: 3, flexWrap: 'wrap' }}>
            {appt.barber_name && (
              <span style={{ ...mono, fontSize: 13, color: T.amber }}>✂ {appt.barber_name}</span>
            )}
        ...
        <div
          style={{ display: 'flex', gap: 6, alignItems: 'center', flexShrink: 0, flexWrap: 'wrap' }}
        >
          {appt.is_walk_in && (
            <span
              style={{
        ...
        >
          ...
          {status === 'pending_shop' && (
            ...
            >
              ...
              >
                Tap when the client arrives and pays. This confirms their spot and releases
                reminders. Slots not confirmed within 1 hour of appointment time are auto-released.
              </p>
              <button
                onClick={() => onStatusChange && onStatusChange(appt.id, 'confirmed')}
                style={{
                  padding: '11px 24px',
                  background: '#fb923c',
                  color: 'black',
          ...
          {(status === 'confirmed' || status === 'no_show') && (
            ...
            >
              ...
              <p style={{ ...mono, fontSize: 13, color: '#52525b', marginTop: 8, lineHeight: 1.6 }}>
                Strike 1 = warning, deposit stays $10. Strike 2+ = deposit increases $1.50 each
                time.
              </p>
            </div>
          )}
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            {(status === 'confirmed' || status === 'pending_shop') && (
              <button
                onClick={() => onRemind && onRemind(appt)}
                style={{
                  padding: '8px 14px',
                  ...sf,
                  fontSize: 12,
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.borderColor = 'rgba(99,91,255,0.6)'
                }}
                onMouseLeave={(e) => {
  ...
  return (
    <div style={{ marginBottom: 32 }}>
      ...
      <div
        style={{
          padding: '20px 22px',
          background: fullySetUp ? 'rgba(34,197,94,0.06)' : 'rgba(139,26,26,0.06)',
            ...
            <div>
              ...
              {fullySetUp ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  />
                  <p style={{ ...mono, fontSize: 13, color: '#4ade80', margin: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <div
                    style={{ width: 6, height: 6, background: '#8B1A1A', borderRadius: '50%' }}
                  />
                  <p style={{ ...mono, fontSize: 13, color: '#8B1A1A', margin: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <div
                    style={{ width: 6, height: 6, background: '#52525b', borderRadius: '50%' }}
                  />
                  <p style={{ ...mono, fontSize: 13, color: '#71717a', margin: 0 }}>
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      setErr(e.response?.data?.error || 'Test setup failed')
                    } finally {
                      setConnecting(false)
                    }
                  }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              ...
              <div key={n} style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                <span
                  style={{ ...mono, fontSize: 13, color: '#635bff', minWidth: 20, flexShrink: 0 }}
                >
                  {n}
                </span>
                <span style={{ ...mono, fontSize: 13, color: '#71717a', lineHeight: 1.6 }}>
                  {t}
                </span>
              </div>
            ))}
      ...
      {fullySetUp && (
        ...
        >
          ...
          >
            ✓ When clients pay online, money goes straight to your Stripe balance.
            <br />
            Click <strong>"View Earnings"</strong> to see your balance and withdraw to your bank
            account.
            <br />
...
function CashAppTagField({ barber, onUpdate }) {
  ...
  return (
    <div>
      ...
      {barber?.cashapp_tag && (
        <p style={{ ...mono, fontSize: 13, color: 'rgba(0,212,95,0.6)', marginTop: 8 }}>
          ...
          {cells.map((d, i) => {
            ...
            return (
              <button
                ...
                onMouseLeave={(e) => {
                  if (!isSel) {
                    e.currentTarget.style.background = isToday ? T.amberDim : 'transparent'
                    e.currentTarget.style.borderColor = isToday ? T.amberBorder : 'transparent'
                  }
                }}
              >
                ...
                {hasAppt && (
                  <div
                    style={{
                      ...
                      animation:
                        !isPast && !isSel ? 'badgePulse 2.5s ease-in-out infinite' : 'none',
                    }}
                  >
                    <span
                      style={{
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: '100%',
          position: 'relative',
          animation: 'cmSlideUp 0.22s cubic-bezier(0.16,1,0.3,1)',
          clipPath:
            'polygon(0 0,calc(100% - 16px) 0,100% 16px,100% 100%,16px 100%,0 calc(100% - 16px))',
        }}
      >
        <div
          style={{ height: 3, background: `linear-gradient(to right,${acc},${acc}44,transparent)` }}
        />
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              width: 12,
              height: 12,
              borderTop: `1.5px solid ${acc}55`,
              borderRight: `1.5px solid ${acc}55`,
            }}
          />
        </div>
        ...
        <div style={{ padding: '4px 24px 24px', display: 'flex', gap: 10 }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = `${acc}30`
              e.currentTarget.style.borderColor = acc
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = `${acc}15`
...
function useConfirm() {
  ...
  const confirm = (opts) =>
    new Promise((resolve, reject) => {
      setModal(
        typeof opts === 'string' ? { type: 'confirm', title: 'Confirm', message: opts } : opts
      )
  ...
  const onConfirm = () => {
    setModal(null)
    if (modalCb) modalCb.resolve(true)
  }
  const onCancel = () => {
    setModal(null)
    if (modalCb) modalCb.reject('cancelled')
  }

  const ModalEl = modal ? (
    <ConfirmModal modal={modal} onConfirm={onConfirm} onCancel={onCancel} />
  ) : null
...
export default function BarberDashboardPage() {
  ...
  const [blastForm, setBlastForm] = useState({
    subject: 'Message from Barbershopnearme Barbershop',
    message: '',
    send_sms: true,
    send_email: true,
  })
  ...
  const loadCalendarDates = useCallback(async (year, month) => {
    try {
      ...
      const dateArr = arr
        .filter(
          (a) => a.status === 'confirmed' || a.status === 'pending_shop' || a.status === 'pending'
        )
        .map((a) => a.date)
  ...
  }, [calYear, calMonth, loadCalendarDates])
  ...
  useEffect(() => {
    if (activeTab === 'gallery') {
      ...
      api
        .get('gallery/')
        .then((d) => setGalleryPhotos(Array.isArray(d) ? d : []))
        .catch(() => {})
  ...
  const issueStrike = async (id, reason) => {
    ...
    try {
      await showConfirm({
        type: 'strike',
        title: 'Issue Strike',
        message: `Issue a ${label} strike to this client? Their deposit fee will increase by $1.50 on their next booking.`,
        badge: 'Deposit fee increases',
    ...
    try {
      ...
      setSchedule((p) =>
        p.map((a) =>
          a.id === id ? { ...a, status: reason === 'no_show' ? 'no_show' : 'cancelled' } : a
        )
      )
  ...
  const handleRemind = async (appt) => {
    ...
    try {
      ...
      showToast(e.response?.data?.error || 'Could not send reminder', 'error')
    }
  }
  ...
  const handleCancel = async (id) => {
    ...
    try {
      await showConfirm({
        ...
        message: `Cancel this appointment for ${clientName}? They will receive a cancellation email immediately.`,
  ...
  useEffect(() => {
    ...
    setWiTime('')
    api
      .get(`available-slots/?barber=${wiBarber}&date=${wiDate}`)
      .then((r) => {
        setWiSlots(r.available_slots || [])
        setWiBooked(r.booked_slots || [])
      })
      .catch(() => {})
  ...
  const summary = {
    today_online: schedule.filter((a) => a.payment_method === 'online' && a.status !== 'cancelled')
      .length,
      ...
      >
        ...
        <div
          style={{
            ...
            width: 600,
            height: 400,
            background: 'radial-gradient(ellipse,rgba(139,26,26,0.08) 0%,transparent 65%)',
            pointerEvents: 'none',
          }}
        />
        <div
          style={{
            ...
            right: 0,
            height: 1,
            background: 'linear-gradient(to right,transparent,rgba(139,26,26,0.3),transparent)',
  ...
  if (!barber)
    return (
      ...
      >
        ...
        >
          <circle cx="16" cy="16" r="10" stroke="#E8DFC8" strokeWidth="3" />
        ...
        >
          Connecting to backend · Make sure Django is running
        </p>
        <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent',
              color: '#E8DFC8',
              border: '2px solid rgba(232,223,200,.65)',
              borderRadius: 50,
              padding: '10px 24px',
              cursor: 'pointer',
            }}
    ...
    <>
      ...
      <div
        style={{
          ...
          width: 700,
          height: 700,
          background: 'radial-gradient(circle,rgba(139,26,26,0.05) 0%,transparent 65%)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
      <div
        style={{
          ...
          width: 500,
          height: 500,
          background: 'radial-gradient(circle,rgba(139,26,26,0.03) 0%,transparent 60%)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
      ...
      >
        <div
          style={{
            ...
            right: 0,
            height: 1,
            background: 'linear-gradient(to right,transparent,rgba(139,26,26,0.18),transparent)',
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 12 : 20 }}>
            ...
            {!isMobile && (
              <>
                ...
                <div>
                  <p style={{ ...mono, fontSize: 13, color: T.muted, letterSpacing: '0.2em' }}>
                    Barber Portal
                  </p>
                </div>
              </>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              >
                <span style={{ ...sf, fontSize: 13, fontWeight: 900, color: 'black' }}>
                  {barber.name?.charAt(0)?.toUpperCase() || 'B'}
                </span>
              </div>
              {!isMobile && (
                <span style={{ ...mono, fontSize: 14, color: '#e4e4e7', fontWeight: 600 }}>
                  {barber.name}
                </span>
              )}
            </div>
        ...
        >
          {TABS.map(({ key, label, icon }) => {
            const pendingReschedules =
              key === 'reschedules' ? reschedules.filter((r) => r.status === 'pending').length : 0
            ...
            return (
              <button
                ...
                onClick={() => {
                  setActiveTab(key)
                  if (key === 'waitlist') setUnreadWaitlist(0)
                }}
                style={{
      ...
      <div
        style={{
          ...
          margin: '0 auto',
          padding: isMobile
            ? '124px max(14px,env(safe-area-inset-left)) max(40px,env(safe-area-inset-bottom))'
            : '128px 36px 72px',
        }}
      >
        {/* ── GREETING + STATS ── */}
        <div
          className="bd-enter"
          style={{ marginBottom: 28, paddingBottom: 28, borderBottom: `1px solid ${T.border}` }}
        >
          <div
            style={{
              display: 'flex',
          ...
          >
            <div>
              ...
              >
                Hey,
                <br />
                <span style={{ color: T.amber, fontStyle: 'italic' }}>{barber.name}_</span>
              </h1>
            </div>
              ...
              >
                <div
                  style={{
                    ...
                    height: 50,
                    background: accent
                      ? 'linear-gradient(225deg,rgba(139,26,26,0.25),transparent)'
                ...
                >
                  <p
                    style={{
                      ...
                      fontSize: isMobile ? 11 : 12,
                      letterSpacing: '0.18em',
                      color: accent ? T.amber : 'rgba(255,255,255,0.65)',
                      textTransform: 'uppercase',
                      margin: 0,
                    }}
                  >
          ...
          <div className="bd-enter">
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div>
                  ...
                  >
                    Barbershopnearme · FEEDBACK
                  </p>
                  <p style={{ ...sf, fontSize: 18, fontWeight: 900, textTransform: 'uppercase' }}>
                    Client Reviews
                  </p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
                {reviews.length > 0 && (
                  ...
                  >
                    <span style={{ ...sf, fontSize: 18, fontWeight: 900, color: T.amber }}>
                    ...
                    <div>
                      <div style={{ display: 'flex', gap: 2 }}>
                        {[1, 2, 3, 4, 5].map((s) => (
                          <span
                            ...
                            style={{
                              color:
                                s <= Math.round(reviewsAvg) ? T.amber : 'rgba(255,255,255,0.1)',
                              fontSize: 10,
                            }}
                          >
                            ★
                      ...
                      <p style={{ ...mono, fontSize: 13, color: T.muted }}>
            ...
            {reviewsLoading ? (
              ...
              >
                ...
                <p style={{ ...mono, fontSize: 13, color: '#52525b' }}>
                      ...
                      <div style={{ padding: '18px 20px' }}>
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            >
                              <span
                                style={{ ...sf, fontSize: 13, fontWeight: 900, color: T.amber }}
                              >
                                {rv.client?.charAt(0)?.toUpperCase() || '?'}
                              </span>
                            </div>
                            <div>
                              <p
                          ...
                          <div style={{ display: 'flex', gap: 2 }}>
                            {[1, 2, 3, 4, 5].map((s) => (
                              <span
                                key={s}
                                style={{
                                  color: s <= rv.rating ? T.amber : 'rgba(255,255,255,0.1)',
                                  fontSize: 14,
                                }}
                              >
                                ★
                        ...
                        {hasReply && !isReplying && (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Your Reply{rv.replied_at ? ` · ${rv.replied_at}` : ''}
                              </p>
                            </div>
                        ...
                        {isReplying && (
                          <div style={{ marginBottom: 10 }}>
                            <textarea
                              ...
                              onChange={(e) =>
                                setReplyText((p) => ({ ...p, [rv.id]: e.target.value }))
                              }
                              rows={3}
                            ...
                            <div style={{ display: 'flex', gap: 8 }}>
                              <button
                                onClick={async () => {
                                  ...
                                  try {
                                    await api.patch(`barber/reviews/${rv.id}/`, {
                                      barber_reply: txt,
                                    })
                                    setReviews((p) =>
                                      p.map((r) =>
                                        r.id === rv.id
                                          ? { ...r, barber_reply: txt, replied_at: 'Today' }
                                          : r
                                      )
                                    )
                                    ...
                                    showToast(
                                      e.response?.data?.error || 'Could not save reply',
                                      'error'
                                    )
                                  } finally {
                                    setReplyBusy((p) => ({ ...p, [rv.id]: false }))
                                  }
                                }}
                                ...
                                style={{
                                  ...
                                  letterSpacing: '0.15em',
                                  textTransform: 'uppercase',
                                  cursor: replyBusy[rv.id] ? 'not-allowed' : 'pointer',
                                  transition: 'all 0.2s',
                                  clipPath:
                                    'polygon(0 0,calc(100% - 6px) 0,100% 6px,100% 100%,6px 100%,0 calc(100% - 6px))',
                                }}
                              ...
                              <button
                                onClick={() => setReplyText((p) => ({ ...p, [rv.id]: '' }))}
                                style={{
                                  padding: '8px 14px',
                                  background: 'transparent',
                                  border: `1px solid ${T.border}`,
                        ...
                        {!isReplying && (
                          <button
                            onClick={() =>
                              setReplyText((p) => ({ ...p, [rv.id]: rv.barber_reply || '' }))
                            }
                            style={{
                              padding: '6px 14px',
                              ...sf,
                              ...
                              textTransform: 'uppercase',
                              background: 'transparent',
                              border: `1px solid ${hasReply ? T.amberBorder : T.border}`,
                              color: hasReply ? T.amber : T.muted,
                              cursor: 'pointer',
                              transition: 'all 0.2s',
                            }}
                            onMouseEnter={(e) => {
                            ...
                            onMouseLeave={(e) => {
                              e.currentTarget.style.borderColor = hasReply
                                ? T.amberBorder
                                : T.border
                              e.currentTarget.style.color = hasReply ? T.amber : T.muted
                            }}
                          >
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                {reschedules.filter((r) => r.status === 'pending').length > 0 && (
                  ...
                  >
                    ...
                    />
                    <span style={{ ...mono, fontSize: 12, color: '#f87171' }}>
                      {reschedules.filter((r) => r.status === 'pending').length} pending
                    </span>
                  </div>
                )}
                <button
                ...
                {[
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: T.surface,
                        border: `1px solid ${isPending ? 'rgba(139,26,26,0.25)' : T.border}`,
                        overflow: 'hidden',
                        clipPath:
                          'polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,12px 100%,0 calc(100% - 12px))',
                      }}
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <div>
                              ...
                              <p style={{ ...mono, fontSize: 13, color: '#71717a' }}>
                                {rr.service_name} · Requested {rr.created_at}
                              </p>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            ...
                            <p
                              style={{
                                ...
                                fontWeight: 700,
                                color: isRejected ? '#8B1A1A' : '#a1a1aa',
                                marginBottom: 4,
                              }}
                            >
                              {rr.original_date}
                            ...
                            <p
                              style={{
                                ...
                                fontWeight: 900,
                                color: isRejected ? '#8B1A1A' : '#71717a',
                              }}
                            >
                              {rr.original_time}
                            </p>
                          ...
                          >
                            ...
                            <p
                              style={{
                                ...
                                fontSize: isMobile ? 10 : 11,
                                fontWeight: 700,
                                color: isPending ? T.amber : isAccepted ? '#22c55e' : '#71717a',
                                marginBottom: 4,
                              }}
                            >
                              {rr.requested_date}
                              ...
                              onClick={async () => {
                                try {
                                  await showConfirm({
                                    ...
                                    message: `Approve ${rr.client_name}'s reschedule to ${rr.requested_date} at ${rr.requested_time}? The client will be notified.`,
                                ...
                                try {
                                  await api.post(`barber/reschedules/${rr.id}/`, {
                                    action: 'accept',
                                  })
                                  setReschedules((p) =>
                                    p.map((r) =>
                                      r.id === rr.id ? { ...r, status: 'accepted' } : r
                                    )
                                  )
                                  ...
                                  showToast(
                                    e.response?.data?.error || 'Could not approve.',
                                    'error'
                                  )
                                }
                              }}
                              ...
                              onClick={async () => {
                                try {
                                  await showConfirm({
                                    ...
                                    message: `Decline ${rr.client_name}'s reschedule request? Their original appointment on ${rr.original_date} at ${rr.original_time} will remain active.`,
                                ...
                                try {
                                  ...
                                  setReschedules((p) =>
                                    p.map((r) =>
                                      r.id === rr.id ? { ...r, status: 'rejected' } : r
                                    )
                                  )
                                  showToast(
                                  ...
                                  showToast(
                                    e.response?.data?.error || 'Could not decline.',
                                    'error'
                                  )
                                }
                              }}
          ...
          <div className="bd-enter">
            ...
            >
              {[
                ...
                {
                  label: 'Confirmed',
                  value: schedule.filter((a) => a.status === 'confirmed').length,
                  color: '#4ade80',
                },
                {
                  label: 'Completed',
                ...
                >
                  ...
                  <p style={{ ...sf, fontSize: 24, fontWeight: 900, color, lineHeight: 1 }}>
                    {value}
                  </p>
                </div>
              ))}
            ...
            {/* ── PAY IN SHOP TRACKER ── */}
            {schedule.filter((a) => a.payment_method === 'shop' && a.status === 'confirmed')
              .length > 0 && (
              <div
                style={{
                  marginBottom: 16,
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {schedule
                    .filter((a) => a.payment_method === 'shop' && a.status === 'confirmed')
                    .map((a) => (
                      <div
                        key={a.id}
                        style={{
                      ...
                      >
                        <div>
                          ...
                          <span style={{ ...mono, fontSize: 13, color: T.muted, marginLeft: 10 }}>
                            {a.service_name}
                          </span>
                          <span style={{ ...mono, fontSize: 13, color: T.amber, marginLeft: 10 }}>
                            {fmtTime(a.time)}
                          </span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          <span style={{ ...sf, fontSize: 12, fontWeight: 900, color: T.amber }}>
                            ${a.service_price || '—'}
                          </span>
                          <button
                            onClick={async () => {
                              try {
                                await showConfirm({
                                  ...
                                  message: `Did you receive $${a.service_price || ''} from ${a.client_name || 'client'}?`,
                                  badge: 'This marks the appointment complete',
                              ...
                              try {
                                await api.patch(`barber/appointments/${a.id}/`, {
                                  status: 'completed',
                                })
                                setSchedule((p) =>
                                  p.map((x) => (x.id === a.id ? { ...x, status: 'completed' } : x))
                                )
              ...
              <div>
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                    <span style={{ ...mono, fontSize: 13, color: T.muted }}>
                      ...
                      return (
                        <div key={appt.id}>
                          <ApptTicket
                            ...
                            onNotes={(id, note) =>
                              setSchedule((p) =>
                                p.map((a) => (a.id === id ? { ...a, barber_notes: note } : a))
                              )
                            }
                          />
                                ...
                                style={{
                                  ...
                                  background:
                                    shopStatus === 'received'
                                      ? 'rgba(34,197,94,0.06)'
                                      : 'rgba(139,26,26,0.04)',
                                  border: `1px solid ${shopStatus === 'received' ? 'rgba(34,197,94,0.2)' : 'rgba(139,26,26,0.15)'}`,
                                  display: 'flex',
                                  justifyContent: 'space-between',
                                  alignItems: 'center',
                                  flexWrap: 'wrap',
                              ...
                              >
                                  ...
                                  <div>
                                    <p
                                      style={{
                                        ...
                                        textTransform: 'uppercase',
                                        letterSpacing: '0.15em',
                                        color: shopStatus === 'received' ? '#4ade80' : T.amber,
                                        marginBottom: 2,
                                      }}
                                    >
                                      {shopStatus === 'received'
                                    ...
                                    <p style={{ ...mono, fontSize: 12, color: '#71717a' }}>
                                ...
                                {shopStatus !== 'received' && (
                                  <div style={{ display: 'flex', gap: 8 }}>
                                    <button
                                      onClick={() =>
                                        setShopPayments((p) => ({ ...p, [appt.id]: 'received' }))
                                      }
                                      style={{
                                        padding: '7px 14px',
                                        background: 'rgba(34,197,94,0.1)',
                                    ...
                                    <button
                                      onClick={() =>
                                        setShopPayments((p) => ({ ...p, [appt.id]: 'pending' }))
                                      }
                                      style={{
                                        padding: '7px 14px',
                                        background: 'transparent',
          ...
          <div className="bd-enter">
            ...
            {reschedLoading ? (
              ...
              >
                ...
                <p style={{ ...mono, fontSize: 13, color: T.muted, marginTop: 8 }}>
                      ...
                      <div style={{ padding: '18px 20px' }}>
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            >
                              <span
                                style={{ ...sf, fontSize: 14, fontWeight: 900, color: T.amber }}
                              >
                                {rr.client_name?.charAt(0)?.toUpperCase() || '?'}
                              </span>
                            </div>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            <span style={{ ...mono, fontSize: 13, color: '#52525b' }}>
                              {rr.created_at}
                            </span>
                            <span
                              style={{
                        ...
                        >
                          ...
                          >
                            ...
                            <p style={{ ...sf, fontSize: 16, fontWeight: 900, color: '#71717a' }}>
                              {rr.original_time}
                            </p>
                            <p style={{ ...mono, fontSize: 12, color: '#52525b', marginTop: 4 }}>
                              {rr.service_name}
                            </p>
                          </div>
                          ...
                          <div style={{ textAlign: 'center', padding: isMobile ? '8px 0' : '0' }}>
                            <span style={{ ...sf, fontSize: 18, color: T.amber, display: 'block' }}>
                              →
                            </span>
                            {isMobile && (
                              <p style={{ ...mono, fontSize: 13, color: '#52525b', marginTop: 4 }}>
                                Requested change
                              </p>
                            )}
                          </div>
                          ...
                          >
                            ...
                            <p
                              style={{
                                ...
                                fontSize: 12,
                                fontWeight: 700,
                                color: isPending ? '#a1a1aa' : isAccepted ? '#4ade80' : '#f87171',
                                marginBottom: 4,
                              }}
                            >
                              {rr.requested_date}
                            ...
                            <p
                              style={{
                                ...
                                fontSize: 16,
                                fontWeight: 900,
                                color: isPending ? T.amber : isAccepted ? '#22c55e' : '#f87171',
                              }}
                            >
                              {rr.requested_time}
                            </p>
                              ...
                              onClick={async () => {
                                try {
                                  await showConfirm({
                                    type: 'approve',
                                    title: 'Approve Reschedule',
                                    message: `Approve ${rr.client_name}'s reschedule to ${rr.requested_date} at ${rr.requested_time}?`,
                                    confirmLabel: 'Approve',
                                    cancelLabel: 'Cancel',
                                  })
                                } catch {
                                ...
                                try {
                                  ...
                                  setReschedules((p) =>
                                    p.map((x) =>
                                      x.id === rr.id ? { ...x, status: 'accepted' } : x
                                    )
                                  )
                                  loadCalendarDates(calYear, calMonth) // badge moves to new date
                                  showToast(
                              ...
                              onClick={async () => {
                                try {
                                  await showConfirm({
                                    type: 'decline',
                                    title: 'Decline Reschedule',
                                    message: `Decline ${rr.client_name}'s request? Original appointment (${rr.original_date} at ${rr.original_time}) stays active.`,
                                    confirmLabel: 'Decline',
                                    cancelLabel: 'Go Back',
                                  })
                                } catch {
                                ...
                                try {
                                  ...
                                  setReschedules((p) =>
                                    p.map((x) =>
                                      x.id === rr.id ? { ...x, status: 'rejected' } : x
                                    )
                                  )
                                  showToast(
                                    `Reschedule declined — ${rr.client_name} has been notified.`,
          ...
          <div className="bd-enter" style={{ maxWidth: 600 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              >
                Walk-In
                <br />
                <span style={{ color: T.amber, fontStyle: 'italic' }}>Check-In_</span>
              </h2>
              <p style={{ ...mono, fontSize: 12, color: T.muted, marginTop: 10, lineHeight: 1.7 }}>
                Someone just walked in? Fill this out and they're in the system instantly. If they
                give a phone or email, they'll get a welcome text or email automatically.
              </p>
            </div>
            ...
            {wiSuccess && (
              ...
              >
                ...
                <p style={{ ...mono, fontSize: 12, color: '#a1a1aa', lineHeight: 1.7 }}>
                  <strong style={{ color: 'white' }}>{wiSuccess.name}</strong> is booked for{' '}
                  <strong style={{ color: T.amber }}>{wiSuccess.service}</strong> at{' '}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {wiBarber && wiDate && (
                <div>
                  ...
                  >
                    ...
                    {wiSlotsLoad ? (
                      <span
                        style={{ ...mono, fontSize: 13, color: '#52525b', letterSpacing: '0.2em' }}
                      >
                        — checking...
                      </span>
                    ) : (
                  ...
                  {wiSlotsLoad ? (
                    ...
                    >
                      <p style={{ ...mono, fontSize: 13, color: T.dim }}>
              ...
              <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: 16 }}>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Phone <span style={{ color: T.dim }}>(for welcome text)</span>
                    </label>
                    <input
                      type="tel"
                      value={wiPhone}
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  >
                    Email <span style={{ color: T.dim }}>(for welcome email)</span>
                  </label>
                  <input
                    type="email"
                    value={wiEmail}
              ...
              {(wiPhone || wiEmail) && wiName && (
                ...
                >
                  ...
                  >
                    "Hey {wiName}! Welcome to Barbershopnearme Barbershop 🔥 You're officially part
                    of the family. We'll take care of you today — see you in the chair!"
                  </p>
                </div>
              )}
              ...
              <button
                ...
                disabled={wiLoading || !wiName.trim() || !wiSvc || !wiTime || !wiBarber}
                style={{
                  padding: '16px',
                  ...sf,
                  fontSize: 13,
                  ...
                  textTransform: 'uppercase',
                  background:
                    wiLoading || !wiName.trim() || !wiSvc || !wiTime || !wiBarber
                      ? T.deep
                      : T.amber,
                  color:
                    wiLoading || !wiName.trim() || !wiSvc || !wiTime || !wiBarber ? T.dim : 'black',
                  border: 'none',
                  cursor:
                    wiLoading || !wiName.trim() || !wiSvc || !wiTime || !wiBarber
                      ? 'not-allowed'
        ...
        {activeTab === 'waitlist' && (
          <div className="bd-enter">
            ...
            >
              ...
              >
                <span style={{ ...mono, fontSize: 13, color: T.amber }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        ...
                        <div>
                          ...
                          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                            ...
                            {(w.email || w.client_email) && (
                              <span style={{ ...mono, fontSize: 12, color: '#a1a1aa' }}>
                                ✉️ {w.email || w.client_email}
                              </span>
                            )}
                            {w.date && (
                              <span style={{ ...mono, fontSize: 12, color: '#a1a1aa' }}>
                          ...
                          {w.notes && !w.notes.includes('[WALK-IN]') && (
                            <p
                              style={{
                                ...mono,
                                fontSize: 12,
                          ...
                          {w.notified && (
                            <p style={{ ...mono, fontSize: 13, color: T.green, marginTop: 4 }}>
                          ...
                          onClick={async () => {
                            try {
                              await showConfirm({
                                ...
                                message: `Remove ${w.client_name} from the waitlist?`,
                                confirmLabel: 'Remove',
                                cancelLabel: 'Cancel',
                              })
                            } catch {
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {[
                  ...
                  {
                    label: 'Strikes',
                    val: clients.filter((c) => (c.strike_count || 0) > 0).length,
                    color: '#f87171',
                  },
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 12, flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  ...
                  color: showAddClient ? '#4ade80' : T.muted,
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                }}
              >
              ...
              <button
                onClick={() => {
                  ...
                  setBlastResult(null)
                  if (!showBlast)
                    setBlastSelected(clients.filter((c) => c.phone || c.email).map((c) => c.id))
                }}
                style={{
                  padding: '9px 16px',
                  ...sf,
                  ...
                  color: showBlast ? T.amber : T.muted,
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                }}
              >
              ...
              >
                  ...
                  {[
                    ...
                    <div key={field}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setAddClientForm((p) => ({ ...p, [field]: e.target.value }))
                        }
                        placeholder={ph}
                        style={{
                          width: '100%',
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button
                    onClick={async () => {
                      if (
                        !addClientForm.name.trim() ||
                        (!addClientForm.phone && !addClientForm.email)
                      ) {
                        showToast('Name + phone or email required', 'error')
                        return
                      }
            ...
            {showBlast && (
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                    <span style={{ ...mono, fontSize: 12, color: T.muted }}>
                      {blastSelected.length} recipients
                    </span>
                    <button
                      onClick={() =>
                        setBlastSelected(clients.filter((c) => c.phone || c.email).map((c) => c.id))
                ...
                <div style={{ display: 'flex', gap: 10, marginBottom: 14 }}>
                  {[
                    ['send_sms', '📱 SMS', blastForm.send_sms],
                    ['send_email', '✉️ Email', blastForm.send_email],
                  ].map(([field, label, on]) => (
                    <button
                      key={field}
                      onClick={() => setBlastForm((p) => ({ ...p, [field]: !p[field] }))}
                      style={{
                        padding: '7px 14px',
                        ...mono,
                        fontSize: 12,
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  >
                    Message{' '}
                    <span style={{ color: '#52525b', textTransform: 'none', letterSpacing: 0 }}>
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder={
                      'Hey {name}! Barbershopnearme Barbershop here — book your next cut online anytime: ' +
                ...
                >
                  {clients.filter((c) => c.phone || c.email).length === 0 ? (
                    ...
                    >
                      No clients with phone or email yet
                    </p>
                  ) : (
                    clients
                      ...
                      .map((cl) => {
                        ...
                        return (
                          <div
                            ...
                            onClick={() =>
                              setBlastSelected((p) =>
                                sel ? p.filter((x) => x !== cl.id) : [...p, cl.id]
                              )
                            }
                            style={{
                              display: 'flex',
                              ...
                              borderBottom: `1px solid ${T.border}`,
                              cursor: 'pointer',
                              background: sel ? 'rgba(139,26,26,0.05)' : 'transparent',
                          ...
                          >
                            <div
                              style={{
                                ...
                                background: sel ? 'rgba(139,26,26,0.2)' : 'transparent',
                                flexShrink: 0,
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                            ...
                            <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                              {cl.phone && (
                                <span style={{ ...mono, fontSize: 13, color: '#4ade80' }}>📱</span>
                              )}
                              {cl.email && (
                                <span style={{ ...mono, fontSize: 13, color: T.amber }}>✉️</span>
                              )}
                            </div>
                          </div>
                        )
                ...
                {blastResult && (
                  <div
                    style={{
                      ...
                      border: `1px solid ${blastResult.ok ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}`,
                      marginBottom: 12,
                    }}
                  >
                    <p
                      style={{
                        ...mono,
                        fontSize: 13,
                        color: blastResult.ok ? '#4ade80' : '#f87171',
                        margin: 0,
                      }}
                    >
                      {blastResult.msg}
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button
                    onClick={async () => {
                      ...
                      if (blastSelected.length === 0) {
                        showToast('Select at least one recipient', 'error')
                        return
                      }
                      if (!blastForm.send_sms && !blastForm.send_email) {
                        showToast('Enable SMS or Email', 'error')
                        return
                      }
                      setBlastBusy(true)
                      setBlastResult(null)
                      try {
                        const recipients = clients
                          .filter((c) => blastSelected.includes(c.id))
                          .map((c) => ({
                            name: c.name,
                            phone: c.phone || '',
                            email: c.email || '',
                    ...
                    style={{
                      ...
                      letterSpacing: '0.15em',
                      textTransform: 'uppercase',
                      cursor: blastBusy ? 'not-allowed' : 'pointer',
                      clipPath:
                        'polygon(0 0,calc(100% - 7px) 0,100% 7px,100% 100%,7px 100%,0 calc(100% - 7px))',
                    }}
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                      <div
                        style={{
                          width: 56,
                          height: 56,
                          background: clientDetail.is_vip ? T.amber : T.amberDim,
                      ...
                      <div>
                        ...
                        <p style={{ ...mono, fontSize: 13, color: '#a1a1aa' }}>
                    ...
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                      <button
                        onClick={async () => {
                          try {
                            ...
                            setClients((p) =>
                              p.map((c) =>
                                c.id === clientDetail.id ? { ...c, is_vip: !c.is_vip } : c
                              )
                            )
                            showToast(
                              clientDetail.is_vip ? 'Removed VIP status' : '⭐ Marked as VIP!'
                            )
                          } catch {
                            showToast('Error.', 'error')
                          }
                        ...
                        style={{
                          ...
                          letterSpacing: '0.15em',
                          textTransform: 'uppercase',
                          background: clientDetail.is_vip ? T.amberDim : 'transparent',
                      ...
                      <button
                          ...
                          if (isBlocked) {
                            ...
                            try {
                              await showConfirm({
                                type: 'danger',
                                title: 'Block Client',
                                message: `Block ${clientDetail.name}? They will no longer be able to book appointments with you.`,
                                badge: 'This cannot be undone easily',
                        ...
                        style={{
                          ...
                          letterSpacing: '0.15em',
                          textTransform: 'uppercase',
                          background: blockList.includes(clientDetail.username || clientDetail.name)
                            ? T.redDim
                            : 'transparent',
                          border: `1px solid ${blockList.includes(clientDetail.username || clientDetail.name) ? T.redBorder : T.border}`,
                          color: blockList.includes(clientDetail.username || clientDetail.name)
                            ? T.red
                            : T.muted,
                          cursor: 'pointer',
                          transition: 'all 0.2s',
                      ...
                      >
                        🚫{' '}
                        {blockList.includes(clientDetail.username || clientDetail.name)
                          ? 'Unblock'
                          : 'Block'}
                      </button>
                    </div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          alignItems: 'center',
                          padding: '14px 18px',
                          background: isBlocked ? 'rgba(248,113,113,0.03)' : T.surface,
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                          <div
                            style={{
                              width: 40,
                              height: 40,
                              background: c.is_vip ? T.amber : isBlocked ? T.redDim : T.surface2,
                          ...
                          >
                            <span
                              style={{
                                ...
                                fontSize: 15,
                                fontWeight: 900,
                                color: c.is_vip ? 'black' : isBlocked ? T.red : T.muted,
                              }}
                            >
                          ...
                          <div>
                            ...
                            >
                              ...
                              {c.is_vip && (
                                <span style={{ ...mono, fontSize: 12, color: T.amber }}>★ VIP</span>
                              )}
                              {strikes > 0 && (
                                <span style={{ ...mono, fontSize: 12, color: '#f87171' }}>
                                  ⚡ {strikes}
                            ...
                            <p style={{ ...mono, fontSize: 13, color: '#71717a' }}>
                              ...
                              {c.last_visit ? `· Last: ${fmtShort(c.last_visit)}` : ''}{' '}
                            </p>
                          </div>
                        </div>
              ...
              <>
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <p style={{ ...sf, fontSize: 26, fontWeight: 900, color, lineHeight: 1 }}>
                        {value}
                      </p>
                    </div>
                  ))}
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ ...sf, fontSize: 16, fontWeight: 900, color: T.green }}>
                      {reports.summary?.completion_rate || 0}%
                    </p>
                  </div>
                  <div
                    style={{ height: 8, background: T.border, borderRadius: 4, overflow: 'hidden' }}
                  >
                    <div
                      style={{
                        height: '100%',
                              ...
                              >
                                ...
                                <div
                                  style={{
                                    ...
                                    background: isToday
                                      ? T.amber
                                      : `linear-gradient(to top,rgba(139,26,26,0.6),rgba(139,26,26,0.3))`,
                                    height: `${Math.max(pct, 3)}%`,
                                    transition: 'height 0.5s ease',
                                    border: isToday ? `1px solid ${T.amber}` : 'none',
                                  }}
                                />
                                <span
                                  style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                          ...
                          >
                            ...
                            <text
                              ...
                              y="47"
                              textAnchor="middle"
                              style={{ fill: 'white', fontSize: '11px', fontWeight: 900 }}
                            >
                              {s.total || 0}
                            </text>
                            <text
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                            {[
                              ...
                              >
                                ...
                                />
                                <span style={{ ...mono, fontSize: 13, color: '#a1a1aa' }}>
                                  {label}
                                </span>
                                <span
                                  style={{
                        ...
                        {reports.busiest_hours?.length > 0 ? (
                          ...
                          >
                            {reports.busiest_hours.map((h, i) => {
                              const maxC = Math.max(
                                ...reports.busiest_hours.map((x) => x.bookings || 0),
                                1
                              )
                              ...
                              return (
                                ...
                                >
                                  <div
                                    style={{
                                      width: '100%',
                                      background: pct > 60 ? T.amber : 'rgba(139,26,26,0.35)',
                        ...
                        return (
                          <div key={i}>
                            ...
                            >
                              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <span
                                  style={{ ...mono, fontSize: 13, color: '#52525b', minWidth: 20 }}
                                >
                              ...
                              <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                                <span
                                  style={{ ...sf, fontSize: 12, color: T.amber, fontWeight: 900 }}
                                >
                                  {s.bookings} cuts
                                </span>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      {reports.top_clients.map((c, i) => (
                        ...
                        >
                          ...
                          <span style={{ ...sf, fontSize: 13, fontWeight: 900, color: T.amber }}>
                            {c.visits} visits
                          </span>
                        </div>
                      ))}
          ...
          <div style={{ padding: '4px 0' }}>
            <p
              style={{
                ...mono,
                fontSize: 13,
                color: 'rgba(232,223,200,.82)',
                marginBottom: 16,
                letterSpacing: '.08em',
              }}
            >
              Upload photos of your work — they show up in the "The Work Speaks" section on the home
              page.
            </p>
            ...
            {galleryMsg && (
              <div
                style={{
                  ...
                  marginBottom: 18,
                  background:
                    galleryMsg.type === 'ok' ? 'rgba(34,197,94,.08)' : 'rgba(248,113,113,.08)',
                  border: `3px solid ${
                    galleryMsg.type === 'ok' ? 'rgba(34,197,94,.35)' : 'rgba(248,113,113,.35)'
                  }`,
              ...
              >
                ...
                <span
                  style={{
                    ...
                    letterSpacing: '.1em',
                    color:
                      galleryMsg.type === 'ok' ? 'rgba(74,222,128,.9)' : 'rgba(248,113,113,.9)',
                  }}
                >
                  {galleryMsg.text}
                </span>
            ...
            >
              <div>
                ...
                <input
                  ...
                  style={{
                    width: '100%',
                    background: 'rgba(232,223,200,.06)',
                    border: '2px solid rgba(232,223,200,.2)',
            ...
            <label
              style={{
                ...
                border: '3px dashed rgba(139,26,26,.45)',
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background = 'rgba(139,26,26,.18)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = 'rgba(139,26,26,.45)'
                e.currentTarget.style.background = 'rgba(139,26,26,.1)'
              }}
            >
            ...
            {galleryLoading ? (
              ...
              <p style={{ ...mono, fontSize: 12, color: 'rgba(232,223,200,.4)' }}>
                No photos yet. Upload your first cut!
              </p>
            ) : (
              <div
                style={{
                ...
                {galleryPhotos.map((p) => (
                  <div
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      border: '2px solid rgba(232,223,200,.22)',
                      aspectRatio: '1',
                    }}
                  >
                    <img
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: '2px solid rgba(232,223,200,.3)',
                        borderRadius: '50%',
                        color: '#E8DFC8',
                        fontSize: 14,
                        cursor: 'pointer',
                      ...
                      onMouseLeave={(e) =>
                        (e.currentTarget.style.background = 'rgba(139,26,26,.85)')
                      }
                    >
                      ×
                    </button>
        ...
        {activeTab === 'newsletter' && (
          <div className="bd-enter">
            ...
            <div
              style={{
                background: T.surface,
                border: `1px solid ${nlEditing ? '#635bff' : 'rgba(139,26,26,0.2)'}`,
                padding: '22px',
                marginBottom: 24,
                clipPath:
                  'polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,12px 100%,0 calc(100% - 12px))',
            ...
            >
              ...
              {nlError && (
                <p style={{ ...mono, fontSize: 13, color: '#f87171', marginBottom: 10 }}>
                  ⚠ {nlError}
                </p>
              )}
              {nlSuccess && (
                <p style={{ ...mono, fontSize: 13, color: '#4ade80', marginBottom: 10 }}>
                  ✓ {nlSuccess}
                </p>
              )}
              ...
              <input
                value={nlForm.title}
                onChange={(e) => setNlForm((p) => ({ ...p, title: e.target.value }))}
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
                <select
                  ...
                  onChange={(e) => setNlForm((p) => ({ ...p, category: e.target.value }))}
                  style={{
                    flex: 2,
                    background: T.bg,
                    border: `1px solid ${T.border}`,
                ...
                <input
                  value={nlForm.emoji}
                  onChange={(e) => setNlForm((p) => ({ ...p, emoji: e.target.value }))}
                  placeholder="Emoji"
                  style={{
                    width: 60,
                    background: T.bg,
                ...
                >
                  <div
                    style={{
                      ...
                      background: nlForm.pinned ? 'rgba(139,26,26,0.15)' : 'transparent',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                    }}
            ...
            {nlLoading ? (
              ...
              >
                ...
                <p style={{ ...mono, fontSize: 13, color: '#71717a', marginTop: 8 }}>
                        ...
                        <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                          ...
                          <button
                            onClick={async () => {
                              ...
                              try {
                                await api.delete(`newsletter/manage/${post.id}/`)
                                setNlPosts((p) => p.filter((x) => x.id !== post.id))
          ...
          <div className="bd-enter" style={{ maxWidth: 580 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              >
                Service
                <br />
                <span style={{ color: T.amber, fontStyle: 'italic' }}>Pricing_</span>
              </h2>
              <p style={{ ...mono, fontSize: 12, color: T.muted, marginTop: 10, lineHeight: 1.7 }}>
                Set your own prices for each service. Your custom price overrides the shop default.
                Clients will see your rate when booking with you.
              </p>
            </div>
            ...
            {pricingList.length === 0 ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {pricingList.map((svc) => {
                  ...
                  const savePrice = async () => {
                    ...
                    try {
                      ...
                      setPricingList((p) =>
                        p.map((s) =>
                          s.id === svc.id
                            ? { ...s, custom_price: val, effective_price: val, is_custom: true }
                            : s
                        )
                      )
                      setPricingEdits((p) => {
                      ...
                      showToast(e.response?.data?.error || 'Could not update price.', 'error')
                    } finally {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: T.surface,
                        border: `1px solid ${hasCustom ? 'rgba(139,26,26,0.2)' : T.border}`,
                        clipPath:
                          'polygon(0 0,calc(100% - 8px) 0,100% 8px,100% 100%,8px 100%,0 calc(100% - 8px))',
                        padding: '16px 18px',
                        transition: 'border-color 0.2s',
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 160 }}>
                          ...
                          <p style={{ ...mono, fontSize: 12, color: T.dim, margin: 0 }}>
                            {svc.duration_minutes} min
                          </p>
                          {hasCustom && (
                            <p
                              style={{ ...mono, fontSize: 13, color: '#52525b', margin: '4px 0 0' }}
                            >
                              Shop default:{' '}
                            ...
                            <>
                              ...
                              >
                                ...
                                <input
                                  ...
                                  value={editVal}
                                  onChange={(e) =>
                                    setPricingEdits((p) => ({ ...p, [svc.id]: e.target.value }))
                                  }
                                  onKeyDown={(e) => {
                ...
                >
                  ...
                  >
                    💲 Custom prices only apply to bookings with you. Other barbers keep their own
                    rates. Press <strong style={{ color: T.amber }}>Edit</strong> to change a price,{' '}
                    <strong style={{ color: '#f87171' }}>Reset</strong> to go back to the shop
                    default.
                  </p>
                </div>
              </div>
        ...
        {activeTab === 'availability' && (
          <div className="bd-enter" style={{ maxWidth: 640 }}>
            ...
            >
              ...
              >
                ...
                <div style={{ position: 'relative', flexShrink: 0 }}>
                  <div
                    style={{
                      ...
                      boxShadow:
                        photoPreview || barber?.photo_url ? '0 0 24px rgba(139,26,26,0.2)' : 'none',
                    }}
                  >
                    {uploadingPhoto ? (
                      <div
                ...
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  >
                    Clients see this photo when choosing who cuts their hair. Upload a clear face
                    shot — it shows up instantly.
                  </p>

                  {/* THE BUTTON — clicking it opens file picker, auto-saves on select */}
                  <label
                    style={{ display: 'block', cursor: uploadingPhoto ? 'not-allowed' : 'pointer' }}
                  >
                    <input
                      type="file"
                      accept="image/*"
                      ...
                      onChange={async (e) => {
                        ...
                        reader.onload = async (ev) => {
                          ...
                          try {
                            ...
                            showToast(
                              err.response?.data?.error || 'Upload failed — try a smaller image.',
                              'error'
                            )
                          } finally {
                      ...
                      <div>
                        <p
                          style={{
                            ...
                            letterSpacing: '0.15em',
                            textTransform: 'uppercase',
                            color: uploadingPhoto ? '#52525b' : '#8B1A1A',
                            margin: 0,
                          }}
                        >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                ...
                <div>
                  ...
                  <p style={{ ...mono, fontSize: 12, color: T.muted, marginTop: 2 }}>
              ...
              <CashAppTagField
                barber={barber}
                onUpdate={(tag) => setBarber((b) => ({ ...b, cashapp_tag: tag }))}
              />
            </div>
            ...
            <p style={{ ...mono, fontSize: 12, color: T.muted, lineHeight: 1.7, marginBottom: 24 }}>
              Set your working hours for each day. Clients can only book during these times.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                          <div
                            style={{
                              ...
                              height: 5,
                              borderRadius: '50%',
                              background: isSun ? T.dim : saved && isWorking ? '#4ade80' : T.dim,
                            }}
                          />
                          <span
                            style={{
                          ...
                          {[
                            ...
                            <button
                              ...
                              style={{
                                ...
                                textTransform: 'uppercase',
                                letterSpacing: '0.15em',
                                background: editWorking === v ? T.amber : 'transparent',
        ...
        {activeTab === 'timeoff' && (
          <div className="bd-enter" style={{ maxWidth: 600 }}>
            ...
            <p style={{ ...mono, fontSize: 12, color: T.muted, lineHeight: 1.7, marginBottom: 24 }}>
              Block specific dates. Clients won't be able to book you on these days.
            </p>
            <div
              style={{
                padding: '20px',
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: '11px 24px',
                  background: !newTimeOffDate || addingTimeOff ? T.deep : T.amber,
                  ...
                  letterSpacing: '0.2em',
                  border: 'none',
                  cursor: !newTimeOffDate || addingTimeOff ? 'not-allowed' : 'pointer',
                  transition: 'all 0.25s',
                }}
              >
            ...
            {timeOff.length === 0 ? (
              <div
                style={{ padding: '40px 0', textAlign: 'center', border: `1px solid ${T.border}` }}
              >
                <p
                  style={{
                    ...sf,
                ...
                {timeOff.map((off) => (
                  ...
                  >
                    <div>
                      ...
                      >
                        {new Date(off.date + 'T00:00:00').toLocaleDateString('en-US', {
                          weekday: 'long',
                          month: 'long',
                          day: 'numeric',
                          year: 'numeric',
                      ...
                      {off.reason && (
                        <p style={{ ...mono, fontSize: 13, color: T.muted }}>{off.reason}</p>
                      )}
                    </div>
                    <button
