          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              ...
              <div key={n} style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                <span
                  style={{ ...mono, fontSize: 8, color: '#635bff', minWidth: 20, flexShrink: 0 }}
                >
                  {n}
                </span>
    ...
    <>
      ...
      >
        ...
        >
          ...
          {!isMobile && (
            <div style={{ textAlign: 'center' }}>
              <p style={{ ...mono, fontSize: 13, color: 'white', letterSpacing: '0.15em' }}>
                {time}
              </p>
              <p
                style={{ ...mono, fontSize: 8, color: T.dim, letterSpacing: '0.3em', marginTop: 2 }}
              >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              {!isMobile && (
                <span style={{ ...mono, fontSize: 13, color: '#a1a1aa' }}>{barber.name}</span>
              )}
            </div>
            <button
      ...
      <div
        style={{
          ...
          margin: '0 auto',
          padding: isMobile
            ? '116px max(14px,env(safe-area-inset-left)) max(40px,env(safe-area-inset-bottom))'
            : '120px 32px 64px',
        }}
      >
        {/* ── GREETING + STATS ── */}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div>
                  ...
                  <p style={{ ...sf, fontSize: 13, fontWeight: 900, textTransform: 'uppercase' }}>
                    Client Reviews
                  </p>
                </div>
              </div>
                ...
                {reviews.length > 0 && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p style={{ ...mono, fontSize: 8, color: T.muted }}>
                      ...
                      <div style={{ padding: '18px 20px' }}>
                        ...
                        >
                          ...
                          <div style={{ textAlign: 'center', padding: isMobile ? '8px 0' : '0' }}>
                            ...
                            {isMobile && (
                              <p style={{ ...mono, fontSize: 8, color: '#52525b', marginTop: 4 }}>
                                Requested change
                              </p>
                            )}
                          </div>
              ...
              {wiBarber && wiDate && (
                <div>
                  ...
                  >
                    ...
                    {wiSlotsLoad ? (
                      <span
                        style={{ ...mono, fontSize: 8, color: '#52525b', letterSpacing: '0.2em' }}
                      >
                        — checking...
                      </span>
                    ) : (
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                          ...
                          <div>
                            ...
                            >
                              ...
                              {c.is_vip && (
                                <span style={{ ...mono, fontSize: 7, color: T.amber }}>★ VIP</span>
                              )}
                              {strikes > 0 && (
                                <span style={{ ...mono, fontSize: 7, color: '#f87171' }}>
                                  ⚡ {strikes}
                                </span>
                              )}
                              {isBlocked && (
                                <span style={{ ...mono, fontSize: 7, color: T.red }}>
                                  🚫 BLOCKED
                                </span>
                              )}
                            </div>
