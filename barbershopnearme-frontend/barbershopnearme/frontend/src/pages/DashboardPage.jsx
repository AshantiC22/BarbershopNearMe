...
const T = {
  ...
  bone3: 'rgba(232,223,200,.22)',
  blood: '#8B1A1A',
  blood2: '#6B0F0F',
  bloodDim: 'rgba(139,26,26,.18)',
  bloodBorder: 'rgba(139,26,26,.4)',
  green: '#4ade80',
  greenDim: 'rgba(74,222,128,.1)',
  greenBorder: 'rgba(74,222,128,.2)',
  red: '#f87171',
  redDim: 'rgba(248,113,113,.07)',
  redBorder: 'rgba(248,113,113,.22)',
  gold: '#C8A840',
  goldDim: 'rgba(200,168,64,.12)',
  goldBorder: 'rgba(200,168,64,.28)',
  orange: '#fb923c',
  orangeDim: 'rgba(251,146,60,.1)',
  orangeBorder: 'rgba(251,146,60,.25)',
  dim: 'rgba(232,223,200,.38)',
  deep: 'rgba(232,223,200,.24)',
}
...
function ApptCard({ appt, onCancel, onRequestCancel, onReschedule, i }) {
  ...
  return (
    <div
      ...
      style={{
        background: T.ink2,
        border: `2px solid ${hovering ? T.bloodBorder : T.bone3}`,
        borderRadius: RH[i % 4],
        boxShadow: hovering
          ? `5px 5px 0 ${T.blood2}, 0 0 24px ${T.bloodDim}`
          : `4px 4px 0 rgba(139,26,26,.18)`,
        position: 'relative',
        overflow: 'hidden',
        ...
        >
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <ScissorsIcon size={14} color={T.blood} opacity={0.8} />
              <p
                style={{
                  ...rub,
                  fontSize: 13,
          ...
          {[
            ...
            <div
              ...
              style={{
                flex: 1,
                minWidth: 90,
                padding: `0 ${mi === 0 ? 0 : 16}px`,
                borderLeft: mi > 0 ? `1px solid ${T.bone3}` : '',
              }}
            >
              <p
                style={{
              ...
              <p
                style={{
                  ...sf,
                  fontSize: 16,
                  color: highlight ? T.blood : T.bone,
                  margin: 0,
                  lineHeight: 1,
                }}
              >
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 16, flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{
                ...
                border: `2px solid rgba(139,26,26,.35)`,
                borderRadius: PILL,
                padding: '8px 16px',
                cursor: 'pointer',
                transition: 'all .2s',
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = 'rgba(139,26,26,.25)'
                e.currentTarget.style.borderColor = 'rgba(139,26,26,.7)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'rgba(139,26,26,.1)'
                e.currentTarget.style.borderColor = 'rgba(139,26,26,.35)'
              }}
            >
              ↻ Reschedule
            </button>
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = 'rgba(248,113,113,.6)'
  ...
  return (
    <div
      style={{
        textAlign: 'center',
        padding: '72px 24px',
        animation: 'rhFadeUp .5s cubic-bezier(.16,1,.3,1) both',
      }}
    >
      <div
        style={{
      ...
      <p style={{ ...mono, fontSize: 12, color: T.deep, lineHeight: 1.7, marginBottom: 28 }}>
        {tab === 'upcoming'
          ? "You've got a clean slate. Book your first cut and take a seat."
          : 'Completed and past appointments will show up here.'}
      </p>
      {tab === 'upcoming' && (
        <button
          onClick={onBook}
...
export default function DashboardPage() {
  ...
  // All useState MUST come before useEffect
  ...
  const upcoming = appts.filter(
    (a) =>
      ['confirmed', 'pending_shop'].includes(a.status) && new Date(a.date + 'T' + a.time) >= now
  )
  const past = appts.filter(
    (a) => a.status === 'completed' || new Date(a.date + 'T' + a.time) < now
  )
    ...
    >
        ...
        >
          <div
            style={{
              ...
              height: 8,
              borderRadius: '50%',
              background: toast.type === 'error' ? T.blood : T.green,
              boxShadow: `0 0 8px ${toast.type === 'error' ? T.blood : T.green}`,
              flexShrink: 0,
            }}
          />
          <span
            style={{
              ...mono,
              fontSize: 12,
              color: toast.type === 'error' ? T.bone : T.green,
              letterSpacing: '.05em',
            }}
          >
            {toast.msg}
      ...
      {cancelModal && (
        <div
          ...
          style={{
            ...
            padding: 20,
            animation: 'rhFadeUp .2s ease both',
          }}
        >
          <div
          ...
          >
            ...
            <div
              style={{
                height: 4,
                background: `linear-gradient(to right,${T.blood},${T.blood2},transparent)`,
              }}
            />
            <div style={{ padding: '24px 26px 20px' }}>
              ...
              >
                ...
                <p style={{ ...mono, fontSize: 13, color: T.blood, margin: '0 0 10px' }}>
                  ✂ {cancelModal.barber_name}
                </p>
                <div style={{ display: 'flex', gap: 16 }}>
                  <div>
                    ...
                    <p style={{ ...sf, fontSize: 13, color: T.bone2, margin: 0 }}>
                      {fmtDate(cancelModal.date)}
                    </p>
                  </div>
                  <div>
                    <p
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = T.bone2
                ...
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: '.08em',
                    textTransform: 'uppercase',
                    background: cancelling ? T.bloodDim : T.blood,
                    color: T.bone,
                    border: `2px solid ${T.bone}`,
                    borderRadius: PILL,
                    cursor: cancelling ? 'not-allowed' : 'pointer',
                    transition: 'all .2s',
                    boxShadow: cancelling ? 'none' : `3px 3px 0 ${T.bone3}`,
                  }}
                  onMouseEnter={(e) => {
                    if (!cancelling) {
                      e.currentTarget.style.background = T.blood2
      ...
      <div
        style={{
          ...
          width: 500,
          height: 500,
          background: `radial-gradient(circle,rgba(139,26,26,.05) 0%,transparent 65%)`,
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
      ...
      <nav
        style={{
          ...
          borderBottom: `3px solid ${T.bone3}`,
          height: 64,
        }}
      >
        <div
      ...
      <div
        style={{
          ...
          margin: '0 auto',
          padding:
            '32px max(16px,env(safe-area-inset-left)) max(80px,calc(40px + env(safe-area-inset-bottom)))',
        }}
      >
        {/* ── HEADER ── */}
        <div
        ...
        >
          <div>
            ...
            >
              Your
              <br />
              <span style={{ color: T.blood }}>Appointments_</span>
            </h1>
          </div>
        ...
        <div
          style={{
            ...
            gap: 4,
            marginBottom: 32,
            borderBottom: `2px solid ${T.bone3}`,
            paddingBottom: 0,
          }}
        >
          {[
            ...
            <button
              ...
              style={{
                ...
                textTransform: 'uppercase',
                background: 'transparent',
                color: tab === key ? T.bone : T.dim,
                border: 'none',
                borderBottom: tab === key ? `3px solid ${T.blood}` : '3px solid transparent',
              ...
              onMouseEnter={(e) => {
                if (tab !== key) e.currentTarget.style.color = T.bone2
              }}
              onMouseLeave={(e) => {
                if (tab !== key) e.currentTarget.style.color = T.dim
              }}
            >
              {label}
            </button>
