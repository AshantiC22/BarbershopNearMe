...
function PushBanner() {
  ...
  if (isIOSSafari) {
    return (
      <div style={{
        ...
        background:'#0F0B09', borderTop:'4px solid #8B1A1A',
        ...
        {/* drag handle */}
        <div style={{width:36,height:4,background:'rgba(232,223,200,.2)',
        ...
        <div style={{display:'flex',alignItems:'flex-start',gap:12,marginBottom:16}}>
          ...
          <div style={{flex:1}}>
            <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:20,
              color:'#E8DFC8',margin:'0 0 5px',textTransform:'uppercase',letterSpacing:'.05em'}}>
              Get Notifications on iPhone
            </p>
            <p style={{fontFamily:"'Courier Prime',monospace",fontSize:12,
              color:'rgba(232,223,200,.75)',margin:0,lineHeight:1.7}}>
          ...
          <button onClick={handleDismiss} style={{background:'none',border:'none',
            color:'rgba(232,223,200,.4)',fontSize:20,cursor:'pointer',padding:0}}>×</button>
        </div>
        ...
        {[
          ...
          <div key={num} style={{display:'flex',alignItems:'center',gap:12,
            background:'rgba(139,26,26,.08)',border:'1px solid rgba(139,26,26,.2)',
            borderRadius:'8px 5px 8px 5px',padding:'10px 14px',marginBottom:8}}>
            <span style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:13,
              color:'#8B1A1A',flexShrink:0,width:16}}>{num}</span>
            <span style={{fontSize:18,flexShrink:0}}>{icon}</span>
            <p style={{fontFamily:"'Courier Prime',monospace",fontSize:12,
              color:'rgba(232,223,200,.8)',margin:0,lineHeight:1.5}}>{text}</p>
          </div>
        ))}
        ...
        <button onClick={handleDismiss} style={{
          ...
          borderRadius:'50px',padding:'10px',cursor:'pointer',
        }}>Maybe Later</button>
      </div>
    )
  }
  ...
  return (
    <div style={{
      ...
      zIndex:999, maxWidth:420, margin:'0 auto',
      background:'#0F0B09', border:'3px solid #8B1A1A',
      ...
      <div style={{display:'flex',alignItems:'flex-start',gap:14}}>
        <span style={{fontSize:26,flexShrink:0}}>🔔</span>
        <div style={{flex:1}}>
          <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:19,
            color:'#E8DFC8',margin:'0 0 5px',textTransform:'uppercase',letterSpacing:'.05em'}}>
            Never Miss Your Cut
          </p>
          <p style={{fontFamily:"'Courier Prime',monospace",fontSize:12,
        ...
        <button onClick={handleDismiss} style={{
          background:'none',border:'none',color:'rgba(232,223,200,.35)',
      ...
      <div style={{display:'flex',gap:10}}>
        ...
        <button onClick={handleDismiss} style={{
          fontFamily:"'Courier Prime',monospace",fontSize:11,
          letterSpacing:'.15em',textTransform:'uppercase',
          background:'none',color:'rgba(232,223,200,.35)',
          border:'2px solid rgba(232,223,200,.12)',borderRadius:'50px',
