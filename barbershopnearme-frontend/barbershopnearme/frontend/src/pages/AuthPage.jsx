  ...
  return (
    <svg
      ...
      style={{
        ...
        filter: 'drop-shadow(3px 3px 0 #8B1A1A)',
      }}
    >
    ...
    >
      ...
      <div
        style={{
          ...
          height: 352,
          background:
            'repeating-linear-gradient(180deg,#E8DFC8 0px,#E8DFC8 18px,#111 18px,#111 36px,#8B1A1A 36px,#8B1A1A 54px)',
...
function WobblyDivider() {
  return (
    <svg
      ...
      style={{ display: 'block', margin: '20px 0', opacity: 0.2 }}
    >
      <path
        d="M0 6 C30 2,60 10,90 6 C120 2,150 10,180 6 C210 2,240 10,270 6 C285 3,293 8,300 6"
        stroke="#E8DFC8"
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
...
function InkSplat({ style = {} }) {
  return (
    ...
    >
      <path
        d="M30 4C36 2,42 8,44 14C50 10,56 16,54 22C60 24,60 32,54 34C58 40,54 48,48 48C50 54,44 58,38 54C36 60,28 60,26 54C20 58,14 54,16 48C10 48,6 40,10 34C4 32,4 24,10 22C8 16,14 10,20 14C22 8,26 2,30 4Z"
        fill="#8B1A1A"
      />
    </svg>
  )
      ...
      <div style={{ position: 'relative' }}>
        ...
        {isPw && (
          <button
            ...
            onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(232,223,200,.35)')}
          >
            {showPw ? '🙈' : '👁'}
          </button>
        )}
      ...
      >
        <div
          style={{
            ...
            pointerEvents: 'none',
            backgroundImage:
              'linear-gradient(rgba(139,26,26,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(139,26,26,.04) 1px,transparent 1px)',
        ...
        <InkSplat
          style={{ bottom: '15%', right: '5%', transform: 'rotate(-20deg)', opacity: 0.05 }}
        />
        ...
        >
          The Chair
          <br />
          <span style={{ color: '#8B1A1A' }}>Awaits</span>
          <br />
          You.
        </div>
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M32 4 L82 14 L32 24 L36 14 Z"
              fill="#8B1A1A"
              stroke="#E8DFC8"
              strokeWidth="2"
            />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <SpinningStar color="#E8DFC8" duration={3.5} delay={0.6} size={18} />
        ...
        <Link
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.borderColor = 'rgba(139,26,26,.4)'
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.color = 'rgba(232,223,200,.3)'
            e.currentTarget.style.borderColor = 'rgba(232,223,200,.12)'
          }}
        >
          ✂ Barber Portal
        </Link>
      ...
      >
        ...
        <div
          style={{
            ...
            height: '140%',
            background:
              'repeating-linear-gradient(170deg,transparent,transparent 50px,rgba(139,26,26,.04) 50px,rgba(139,26,26,.04) 51px)',
            pointerEvents: 'none',
          }}
        />
        ...
        >
          {/* mobile logo */}
          <div
            style={{ display: 'none', textAlign: 'center', marginBottom: 28 }}
          ...
          >
            <InkSplat
              style={{ top: '-20px', right: '-20px', transform: 'rotate(25deg)', opacity: 0.06 }}
            />
            <div
              style={{
                position: 'absolute',
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              >
                ...
                Client Portal
                <SpinningStar size={10} duration={3} delay={0.5} color="#E8DFC8" />
              </div>
              <h1
                style={{
                  fontFamily: "'Bebas Neue',sans-serif",
    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center', maxWidth: 420 }}>
          ...
          >
            If that account exists, a reset link is on its way. Check your spam folder too.
          </p>
          <Link
            to="/login"
            style={{
...
export function LoginPage() {
  ...
  if (showTrans)
    return (
      <PortalTransition
        onDone={() => navigate(returnTo, preBarber ? { state: { barber: preBarber } } : undefined)}
      />
    )
      ...
      extraLinks={
        <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
          <Link
            ...
            onMouseLeave={(e) => (e.target.style.color = 'rgba(232,223,200,.3)')}
          >
            Forgot password?
          </Link>
          <Link
    ...
    <AuthLayout
      ...
      extraLinks={
        <Link
          ...
          onMouseLeave={(e) => (e.target.style.color = 'rgba(232,223,200,.3)')}
        >
          Are you a barber? Barber portal →
        </Link>
      }
    >
      <Field
