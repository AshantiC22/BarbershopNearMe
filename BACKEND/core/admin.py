...
# ── Branding ──────────────────────────────────────────────────────────────────
admin.site.site_header  = "✂ Barbershopnearme  |  Shop Command Center"
admin.site.site_title   = "Barbershopnearme Admin"
...
class BarbershopAdminMixin:
    """Injects Barbershopnearme dark theme CSS into every admin page."""
    class Media:
        pass

    def changelist_view(self, request, extra_context=None):
        extra_context = extra_context or {}
        extra_context["bsnm_css"] = mark_safe(BSNM_CSS)
...
class AppointmentAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class UserProfileAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class BarberAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class ServiceAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class BarberAvailabilityAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class BarberTimeOffAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class ReviewAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class WaitlistEntryAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class BarberClientAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class RescheduleRequestAdmin(BarbershopAdminMixin, admin.ModelAdmin):
...
class PushSubscriptionAdmin(BarbershopAdminMixin, admin.ModelAdmin):
    list_display  = ("user", "created_at", "updated_at")
    search_fields = ("user__username",)


@admin.register(NewsletterPost)
class NewsletterPostAdmin(BarbershopAdminMixin, admin.ModelAdmin):
