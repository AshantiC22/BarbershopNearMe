...
# Railway custom domain active - barbersnearme.xyz verified
...
FRONTEND_URL = os.environ.get("FRONTEND_URL", "https://barbershopnearme-barbershop-website.vercel.app")
BACKEND_URL  = os.environ.get("BACKEND_URL",  "https://barbershopnearme-barbershop-website-production.up.railway.app")

# ── Email — SendGrid HTTP API (not SMTP — Railway blocks port 587) ────────────
SENDGRID_API_KEY   = os.environ.get("SENDGRID_API_KEY", "")
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "Barbershopnearme <noreply@barbershopnearme.com>")
...
BARBER_INVITE_CODE = os.environ.get("BARBER_INVITE_CODE", "BARBERSHOPNEARME2026")
